<form id="form-save-room" class="row g-3" method="POST" action="{{ route('room.update', ['room' => $room->id]) }}">
    ...
    @csrf
    <div class="col-md-12">
        <label for="type_id" class="form-label">Quận/Huyện</label>
    ...
    <div class="col-md-12">
        <label for="number" class="form-label">Tên phòng</label>
    ...
    <div class="col-md-12">
        ...
        <input room="text" class="form-control @error('acreage') is-invalid @enderror" id="acreage"
               name="acreage" value="{{ $room->acreage }}" placeholder="ex: 4">
        <div id="error_capacity" class="text-danger error"></div>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        ...
        <input room="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location"
               value="{{ $room->location }}" placeholder="........">
