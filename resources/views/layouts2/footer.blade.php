                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <div class="group-xs">
                                        <div>
                                            <dl class="list-desc">
                                                <dt>Các ngày trong tuần: </dt>
                                                <dd class="text-gray-darker"><span>8:00–20:00</span></dd>
                                            </dl>
                                        </div>
                                        <div>
                                            <dl class="list-desc">
                                                <dt>Nhưng ngay cuối tuần: </dt>
                                ...
                                <li>
                                    <p class="rights"><span>&copy;&nbsp;</span><span>2019</span><span>&nbsp;</span><span class="copyright-year"></span>
                                        Biệt thự hoàng gia. Đã đăng ký Bản quyền. Thiết kế bởi<a href="https://www.templatemonster.com">TemplateMonster</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <li>
                                    <dl class="list-desc">
                                        ...
                                        <dd class="text-gray-darker">
                                            Gọi cho chúng tôi: <a class="link link-gray-darker" href="tel:#">+1 (409) 987–5874</a>
                                        </dd>
                                    </dl>
                                </li>
                            </ul>
                        ...
                        <div class="page-footer-minimal-inner-subscribe">
                            ...
                            <form class="rd-mailform rd-mailform-inline form-center" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="bat/rd-mailform.php">
                                <div class="form-wrap">
                                    ...
                                    <label class="form-label" for="subscribe-email">Nhập email của bạn</label>
                                </div>
                                <button class="button button-primary-2 button-effect-ujarak button-square" type="submit"><span>Đăng Kí</span></button>
                            </form>
                        </div>
                    </div>
                </div>
